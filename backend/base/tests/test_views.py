...
class TestViews(APITestCase):
    def setUp(self):
        self.admin_user = User.objects.create_superuser(
            username="admin", password="adminPassword", email="admin@gmail.com"
        )
    ...
    def test_token_obtain_pair(self):
        ...
        response = self.client.post(
            url, data={"username": self.user.username, "password": "testPassword1"}
        )
    ...
    def test_create_order(self):
        ...
        items_data = [
            {"product_id": self.product.pk, "quantity": 2, "price": self.product.price}
        ]
        ...
        response = self.client.post(
            reverse("create_order"), data=order_data, format="json"
        )
    ...
    def test_blacklist_token_update(self):
        ...
        response = self.client.post(
            reverse("blacklist"), {"refresh_token": str(refresh)}
        )
